...
namespace AdvantShop.Core.Common.Extensions
{
    public static class InplaceExtensions
    {
        ...
        public static HtmlString InplaceProductDescription(this HtmlHelper helper, int productId, ProductInplaceField field, bool editorSimple = false, bool bindable = false)
        {
            ...
            return new HtmlString(InplaceStringFormat(productId.ToString(), InplaceType.Product, field, "productext/inplaceeditorproduct", editorSimple ? richSimple : string.Empty, "Нажмите сюда, чтобы добавить описание", bindable));
        }
