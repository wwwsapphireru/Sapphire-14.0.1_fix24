...
{
    public class ProductListHandler_0
    {
        #region Fields
        ...
        public ProductListHandler_0(EProductOnMain type, bool indepth, CategoryModel categoryModel, int? productListId, bool isMobile, int? salesType)
        {
            _type = type;
            _indepth = indepth;
        ...
        private void BuildSorting()
        {
            ...
            switch (sort)
            {
                ...
                default:
                    ...
                    _paging.OrderBy("Product.ProductID".AsSqlField("ProductIDSorting"));
                    break;
            }
        }
